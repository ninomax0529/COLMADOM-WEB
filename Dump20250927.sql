...
CREATE TABLE `detalle_salida_inventario` (
  ...
  `unidad` int NOT NULL,
  `cantidad` double NOT NULL,
  `existencia` double NOT NULL COMMENT 'Existencia despues de la salida',
  `precio` double NOT NULL,
  `valor` double NOT NULL,
  `existencia_anterior` double NOT NULL COMMENT 'Existencia antes de la salida',
...
CREATE TABLE `salida_inventario` (
  ...
  `comentario` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `fecha_contabilizacion` timestamp NULL DEFAULT NULL,
  `moneda` int DEFAULT NULL,
  `solicitante` varchar(80) DEFAULT NULL,
  `tipo_salida` int DEFAULT NULL,
  `proyecto` varchar(80) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `anulada` tinyint(1) NOT NULL,
  `fecha_anulada` timestamp NULL DEFAULT NULL,
  `usuario` int DEFAULT NULL,
  `anulada_por` int DEFAULT NULL,
  `almacen` int DEFAULT NULL,
  `unidad_de_negocio` int DEFAULT NULL,
...
-- Dump completed on 2025-09-27 14:00:05
